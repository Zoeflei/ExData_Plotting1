...
##topleft: plot from plot2
plot(epConsumptionSubset$Global_active_power ~ epConsumptionSubset$Datetime, 
     type = "l", ylab = "Global Active Power (kilowatts)", xlab = "")

##top right: Voltage v. "datetime"
plot(epConsumptionSubset$Voltage ~ epConsumptionSubset$Datetime, 
     type = "l", ylab = "Voltage", xlab = "datetime")

##bottomleft: plot from plot3
...
plot(epConsumptionSubset$Global_reactive_power ~ epConsumptionSubset$Datetime, 
